...
export function MassMarketRecordCard({ record, number }: Props) {
      ...
      >
        <div className="flex flex-col gap-3">
          <div className="aspect-[3/4] rounded-sm border border-[var(--border-subtle)] bg-[var(--paper)] p-3">
            <div className="h-12 w-12 rounded-sm bg-[var(--border-subtle)]" />
            ...
            <div className="mt-4 flex gap-1.5">
              <span className="rounded-sm border border-[var(--border-subtle)] px-1.5 py-0.5 text-[0.55rem] text-[var(--ink-faint)]">
                趣味
              </span>
              <span className="rounded-sm border border-[var(--border-subtle)] px-1.5 py-0.5 text-[0.55rem] text-[var(--ink-faint)]">
                婚活
          ...
          <p className="text-center font-mono text-[0.6rem] text-[var(--ink-faint)]">
            相互マッチ待ち
          </p>
        </div>
      </div>
