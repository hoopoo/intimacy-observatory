...
export function ImmediateRecordCard({ record, number }: Props) {
      ...
      >
        <div className="flex flex-col gap-3">
          <div className="aspect-[3/4] rounded-sm border border-[var(--border-subtle)] bg-[var(--paper)] p-3">
            ...
            <div className="mt-2 h-24 rounded-sm bg-[var(--border-subtle)]" />
            <div className="mt-3 flex justify-center gap-4">
              <span className="h-8 w-8 rounded-full border border-[var(--border-subtle)]" />
              <span className="h-8 w-8 rounded-full border-2 border-[var(--accent-violet)]" />
            </div>
