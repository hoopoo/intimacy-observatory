import { INTERNATIONAL_DESIRE_FRAMES } from "@/data/encounter-international";
import { FadeInOnScroll } from "./FadeInOnScroll";

export function InternationalDesireFraming() {
  return (
    <section
      id="desire-framing"
      className="border-b border-[var(--border)]"
      aria-labelledby="international-desire-framing-heading"
    >
      <div className="mx-auto max-w-3xl px-5 py-16 md:py-20">
        <FadeInOnScroll>
          <p className="annotation mb-2">Desire framing</p>
          <h2
            id="international-desire-framing-heading"
        ...
        <FadeInOnScroll delayMs={60}>
          <ul className="mt-10 flex flex-col gap-4">
            {INTERNATIONAL_DESIRE_FRAMES.map((item) => (
              <li
                key={item.frame}
