import { MARRIAGE_IDENTITY_VS_MASS_MARKET } from "@/data/encounter-marriage-identity";
import { FadeInOnScroll } from "./FadeInOnScroll";

export function MarriageIdentityVsMassMarket() {
  return (
    <section
      id="marriage-identity-vs-mass-market"
      className="border-b border-[var(--border)] bg-[var(--paper-raised)]"
      aria-labelledby="marriage-identity-vs-mass-market-heading"
    >
      <div className="mx-auto max-w-6xl px-5 py-16 md:py-20">
        <FadeInOnScroll>
          <p className="annotation mb-2">Identity-specific vs mass-market</p>
          <h2
            id="marriage-identity-vs-mass-market-heading"
        ...
        <div className="mt-10 hidden gap-6 lg:grid lg:grid-cols-2">
          {[
            MARRIAGE_IDENTITY_VS_MASS_MARKET.marriageIdentity,
            MARRIAGE_IDENTITY_VS_MASS_MARKET.massMarket,
          ].map((side) => (
            <article
              key={side.labelEn}
